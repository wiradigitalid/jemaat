...
const artboards = [
  ...
  { file: 'AdminHousehold.dc.html', title: 'W26 A household', x: 0, y: 1954, w: 1440, h: 900, page: 'page-8' },
  { file: 'AdminGroups.dc.html', title: 'W24 Care groups', x: 1520, y: 1954, w: 1440, h: 900, page: 'page-8' },
  { file: 'AdminChurch.dc.html', title: 'W25 The church record', x: 0, y: 2934, w: 1440, h: 900, page: 'page-8' },
  { file: 'AdminScope.dc.html', title: 'S12 The register, alone', x: 0, y: 3914, w: 1440, h: 1020, page: 'page-8' },
  { file: 'AdminModel.dc.html', title: 'S14 Household, family, and the address', x: 0, y: 5054, w: 1440, h: 1080, page: 'page-8' },
  { file: 'AdminRelease.dc.html', title: 'S13 What ships: the register', x: 0, y: 6254, w: 1440, h: 1150, page: 'page-8' },
];

const modelNote2 = {
  id: 'n-household', x: 1520, y: 5054, w: 540, page: 'page-8',
...
const webNote = {
  id: 'n-admin', x: 1520, y: 3914, w: 540, page: 'page-8',
...
const webShipNote = {
  id: 'n-adminship', x: 1520, y: 6254, w: 540, page: 'page-8',
