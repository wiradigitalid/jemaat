...
<div style="width:1440px;height:900px;background:${C.bg};display:flex;flex-direction:column;">
  ...
  <div style="flex:1 1 auto;min-height:0;display:flex;gap:40px;padding:26px 32px;justify-content:center;">
    ...
    <div style="width:590px;flex:0 0 590px;display:flex;flex-direction:column;gap:16px;">
      ...
      ${card(rows([
        matchRow('Keluarga Prasetyo', '5 people &middot; Sunter Agung Q4/12', true),
      ...
      ${fieldWrap('AREAS OF INVOLVEMENT', `<div style="display:flex;flex-wrap:wrap;gap:8px;">${[['Music', true], ['Multimedia', false], ['Prayer', true], ['Teaching', false], ['Visitation', false]].map(([t, on]) => tag(t, on)).join('')}</div>`, { tag: 'any number' })}
...
${pad(`
  ...
  ${card(rows([
    matchRow('Keluarga Prasetyo', '4 people &middot; Sunter Agung Q4/12', true),
    matchRow('Create a new household', 'For a different address'),
  ]), 'margin-top:-6px;')}
...
<div style="width:1440px;height:900px;background:${C.bg};display:flex;flex-direction:column;">
  <div style="display:flex;align-items:center;gap:14px;padding:20px 32px;background:${C.surfaceAlt};border-bottom:1px solid ${C.line};">
    ...
    <div style="flex:1 1 auto;min-width:0;">
      ...
      <div style="font-size:12px;color:${C.ink3};margin-top:2px;">6 people &middot; Sunter Agung Q4/12</div>
    </div>
    ...
    <div style="flex:1 1 auto;min-width:0;display:flex;flex-direction:column;gap:16px;">
      ...
      ${card(`
        ...
        ${rows([
          ...
          occupant('KP', 'Kevin Prasetyo', 'Grandchild', 'Member &middot; 20 &middot; boarding in Bandung', pill('Own address', C.bg, C.ink3, `border:1px solid ${C.line};`)),
        ])}
    ...
    <div style="width:834px;flex:0 0 834px;display:flex;flex-direction:column;gap:20px;">
      ...
      ${card(`
        <div style="padding:16px 16px 12px;border-bottom:1px solid ${C.lineSoft};">
          ...
          <div style="font-size:12px;color:${C.ink2};margin-top:6px;line-height:1.5;">Every other flow in these 90 artboards is two-sided. Take away three of the four roles and each one loses the half that starts it.</div>
        </div>
...
<div style="width:1440px;height:1080px;background:${C.bg};display:flex;flex-direction:column;padding:40px;gap:22px;">
  <div style="display:flex;align-items:flex-end;gap:24px;">
    <div style="flex:1 1 auto;">
...
<div style="width:1440px;height:1150px;background:${C.bg};display:flex;flex-direction:column;padding:40px;gap:22px;">
  <div style="display:flex;align-items:flex-end;gap:24px;">
    <div style="flex:1 1 auto;">
      ...
      <div style="font-size:13px;color:${C.ink2};margin-top:8px;line-height:1.55;max-width:940px;">S1 staged R0 across an app and a web side, and this column has now been re-derived twice &mdash; once for one surface, and again for one role. Seventeen routes, seven capabilities, with the two-week item named where it can be seen rather than hidden inside a sprint.</div>
    </div>
    <div style="text-align:right;">
      <div style="font-family:${SERIF};font-size:34px;font-weight:600;">17</div>
      <div style="font-size:11px;color:${C.ink3};line-height:1.6;margin-top:4px;">routes &middot; 7 capabilities<br>one role, one surface</div>
    </div>
  </div>
      ...
      ${card(`
        <div style="padding:15px 16px 12px;background:${C.bg};border-bottom:1px solid ${C.line};">
          <div style="display:flex;align-items:baseline;gap:10px;">
            ...
            <div style="flex:1 1 auto;"></div>
            <span style="font-size:11px;font-weight:700;color:${C.ink3};">17 routes &middot; 7 capabilities</span>
          </div>
          <div style="font-size:12px;color:${C.ink2};margin-top:8px;line-height:1.55;">Tenancy, admin auth, the register, households, import, export and merge. The seventh capability is the map: tiles, address search and a stored coordinate.</div>
        </div>
