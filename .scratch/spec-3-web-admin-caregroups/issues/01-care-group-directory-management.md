...
1. Backend API:
   ...
   - `POST /api/v1/care-groups/:id/members`: Enroll or transfer an active member (`person_id`) into care group.
...
## Acceptance Criteria
1. Administrator can create care groups, assign designated leaders, and enroll members from people registry.
